...
If frmInternal.List1.Text = "Zauberschlüssel" Or frmInternal.List1.Text = "Schriftrolle 'Schlösser öffnen'" Then DelItem: Label61.Caption = "": SchatzFree199 Else MsgBox "Das bewirkt nichts!", 64 + 0, "Ergebnis"
End Sub
...
truhe4 = 1
HöhlenE2.Shape1(2).Visible = False
Unload HöTruhe4
HöhlenE2.Show
