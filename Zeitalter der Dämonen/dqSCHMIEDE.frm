...
Titel = Inhaber
If Inhaber = "Karadus" Then Text = "Hast du schon von dem Seelenjäger gehört, der in Aysalia sein Unwesen treib? Er soll von Dalerok, dem Dämonenfürsten kommen."
...
If Inhaber = "Atlanta" Then Text = "Siehst du meine Muskeln? Gut, ich hoffe du bezahlst auch für meine Arbeit."
onlyOK
...
A = List1.Text
WeaponCheck
If dqHÄNDE = 1 Then A = "einhändig" Else A = "zweihändig"
